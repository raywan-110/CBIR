...
WEIGHT_DECAY = 0.001
N_EPOCH = 2
MODEL_SAVE_PATH = 'trained_model/model_m0.5.pth'
...
CRITERION = HardTripletLoss(margin=0.05, hardest=True, squared=True)
...
base_model = VGGNet(load_model_path=LOAD_MODEL_PATH, requires_grad=True)
